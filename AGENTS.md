...
Reines **Vite + Vanilla HTML/CSS/JS** (keine Frameworks). Thema = Inhalt der Lernkarten.
...
| **Themen-Inhalte**                     | `src/js/modules/data/<kategorie>.js` (`gestaltung/farbe-typo/bild-grafik/web-ux`).                                             |
